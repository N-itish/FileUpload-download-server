...
public class StreamVideo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Retrieving file from the source
            //Reteriving the file path from the database
        VideoDAO dao = new VideoDAOImpl();
        String id = request.getParameter("ident");
        String video_name = dao.getFolder(Integer.parseInt(id));
        response.getWriter().write(video_name);       
    }
